...
;; ## added by OPAM user-setup for emacs / tuareg ## c5d5faa086aa32b3e538c2c97dcbc38d ## you can edit, but keep this line
...
(when (not (member "tuareg" opam-tools-installed))
  (defun opam-tuareg-autoload (fct file doc args)
    (let ((load-path (cons "/home/omar/.opam/4.03.0/share/emacs/site-lisp" load-path)))
      (load file))
    (apply fct args))
